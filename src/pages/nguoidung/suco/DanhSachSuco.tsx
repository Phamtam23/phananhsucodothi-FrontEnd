...
import diaDiem from "../../../assets/location-pin.png"
  ...
  return (
    <div className="danh-sach-su-co">
      ...
      <div className="filter-group">
        ...
        <div className="filter-select-wrapper">
          <span className="filter-label">Loại sự cố</span>
          <select
        ...
        <div className="filter-input-wrapper">
          <span className="filter-label">Tên sự cố</span>
        ...
        <div className="filter-input-wrapper">
          ...
          <span className="filter-icon"><img src={diaDiem} alt="diaDiem" /></span>
          <input
            type="text"
